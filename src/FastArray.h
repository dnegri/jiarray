...
template <class T, std::size_t SIZE, std::size_t OFFSET = JIARRAY_OFFSET> class FastArray {
  ...
  public:
    ...
    template <size_t array_size> explicit FastArray(T (&a)[array_size]) {
        for (size_t i = 0; i < SIZE; i++) {
            mm[i] = a[i];
        }
    }
...
template <int I> using fbool1d = dnegri::jiarray::FastArray<bool, I>;

template <int I> using fint1d = dnegri::jiarray::FastArray<int, I>;

template <int I> using ffloat1d = dnegri::jiarray::FastArray<float, I>;
...
template <int I> using fstring1d = dnegri::jiarray::StringFastArray<I>;

template <int I, int J> using fbool2d = dnegri::jiarray::FastArray2D<bool, I, J>;

template <int I, int J> using fint2d = dnegri::jiarray::FastArray2D<int, I, J>;

template <int I, int J> using ffloat2d = dnegri::jiarray::FastArray2D<float, I, J>;

template <int I, int J> using fdouble2d = dnegri::jiarray::FastArray2D<double, I, J>;

template <class T, int I> using farray = dnegri::jiarray::FastArray<T, I>;
