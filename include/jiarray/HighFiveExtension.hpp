...
#include "JIArray.h"
#include "JIVector.h"
// JICudaArray.h requires CUDA toolkit headers; only include it when
// compiling CUDA translation units so non-CUDA targets can still use
// the HighFive<->JIArray bridge.
#ifdef __CUDACC__
